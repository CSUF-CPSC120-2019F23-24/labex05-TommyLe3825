...
int main()
{
  ...
  std::cout << "\nBoth d2 and f2 are now getting different values from each other" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nd2 continues to increase while f2 has become all 0" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nBoth d3 and f2 are maxed out" << std::endl;
